...
class AlbumTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #Crea una colección para hacer las prueba
        ...
        self.album2 = Album(titulo='La voz de los 80s', ano=1984, descripcion='No tiene', medio=Medio.CASETE,
                            canciones=[])
        self.album3 = Album(titulo='Pateando piedras', ano=1986, descripcion='No tiene', medio=Medio.DISCO,
                            canciones=[])
    ...
    def test_editar_album(self):
        ...
        resultado2 = self.coleccion.editar_album(album_id=2, titulo="Pateando piedras", anio=1985,
                                                 descripcion="No tiene", medio=Medio.CASETE)
